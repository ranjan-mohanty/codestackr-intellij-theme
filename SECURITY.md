...
- The codeSTACKr Theme plugin code
- Theme configuration files
- Build and distribution processes

This policy does NOT cover:

- Issues in IntelliJ IDEA or JetBrains IDEs themselves
- Third-party dependencies (report those to the respective projects)
- User configuration or misuse
...
Thank you for helping keep codeSTACKr Theme and its users safe!
